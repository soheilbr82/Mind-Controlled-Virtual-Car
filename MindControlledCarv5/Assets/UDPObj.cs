...
public class UDPObj : MonoBehaviour
{
	...
	//Ports
	public int portLocal = 50000;
	public int portRemote = 50001;
	...
	void OnGUI ()
	{
        Rect rectObjFR = new Rect(200, 10, 200, 20);
        GUI.Box(rectObjFR, "Frame rate:" + 1 / Time.deltaTime);
		...
		inputNumber + "\n\nAll Messages: \n" + tenPacket /*allReceivedUDPPackets*/
			, style);
    ...
    private void Parsing(string input)
    {
		...
		//else if (label == "SignalLeft")
		//	leftNum = num;
		//else if (label == "SignalRight")
		//	rightNum = num;
		//else if (label == "SignalTop")
		//	topNum = num;
		//else if (label == "SignalBottom")
		//	bottomNum = num;
