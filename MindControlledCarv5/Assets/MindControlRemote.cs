...
public class MindControlRemote : MonoBehaviour
{
        ...
        void Update()
    {
        ...
        //float topSignalNum = UDPObj.topNum;
        //float bottomSignalNum = UDPObj.bottomNum;
        //float leftSignalNum = UDPObj.leftNum;
        //float rightSignalNum = UDPObj.rightNum;
        //string InputSignalFix = UDPObj.inputString;


        //if (direction == 1 && (topSignalNum != 0 || bottomSignalNum != 0 || leftSignalNum != 0 || rightSignalNum != 0 )) {
        ...
        //}
        //else if (direction == 1 && topSignalNum == 0 && bottomSignalNum == 0 && leftSignalNum == 0 && rightSignalNum == 0) {
        //	Break();
        //}
